...
@kotlin.Metadata(mv = {1, 9, 0}, k = 1, xi = 48, d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0006\bg\u0018\u00002\u00020\u0001J\u0016\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u00a7@\u00a2\u0006\u0002\u0010\u0006J\u0016\u0010\u0007\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\tH\u00a7@\u00a2\u0006\u0002\u0010\nJ\u0014\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\fH\'J\u0014\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\fH\'J\u0018\u0010\u000f\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0010\u001a\u00020\tH\u00a7@\u00a2\u0006\u0002\u0010\nJ\u001c\u0010\u0011\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\f2\u0006\u0010\u0012\u001a\u00020\u0013H\'J$\u0010\u0014\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\f2\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\u0012\u001a\u00020\u0013H\'J\u001c\u0010\u0015\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\f2\u0006\u0010\b\u001a\u00020\tH\'J\u001c\u0010\u0016\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00050\r0\f2\u0006\u0010\b\u001a\u00020\tH\'J\u0016\u0010\u0017\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u00a7@\u00a2\u0006\u0002\u0010\u0006J\u0016\u0010\u0018\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u00a7@\u00a2\u0006\u0002\u0010\u0006\u00a8\u0006\u0019"}, d2 = {"Lcom/example/StudyApp/data/FlashcardDao;", "", "delete", "", "flashcard", "Lcom/example/StudyApp/data/Flashcard;", "(Lcom/example/StudyApp/data/Flashcard;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "deleteAllForDeck", "deckId", "", "(JLkotlin/coroutines/Continuation;)Ljava/lang/Object;", "getAllFlashcardsByCreation", "Lkotlinx/coroutines/flow/Flow;", "", "getAllFlashcardsByReview", "getById", "id", "getDueFlashcards", "date", "Ljava/util/Date;", "getDueFlashcardsForDeck", "getFlashcardsForDeckByCreation", "getFlashcardsForDeckByReview", "insert", "update", "app_debug"})
@androidx.room.Dao()
public abstract interface FlashcardDao {
    
    @androidx.room.Query(value = "SELECT * FROM flashcards ORDER BY nextReviewDate ASC")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getAllFlashcardsByReview();
    
    @androidx.room.Query(value = "SELECT * FROM flashcards ORDER BY createdAt DESC")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getAllFlashcardsByCreation();
    
    @androidx.room.Query(value = "SELECT * FROM flashcards WHERE deckId = :deckId ORDER BY nextReviewDate ASC")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getFlashcardsForDeckByReview(long deckId);
    
    @androidx.room.Query(value = "SELECT * FROM flashcards WHERE deckId = :deckId ORDER BY createdAt DESC")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getFlashcardsForDeckByCreation(long deckId);
    
    @androidx.room.Query(value = "SELECT * FROM flashcards WHERE nextReviewDate <= :date OR nextReviewDate IS NULL")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getDueFlashcards(@org.jetbrains.annotations.NotNull()
    java.util.Date date);
    
    @androidx.room.Query(value = "SELECT * FROM flashcards WHERE deckId = :deckId AND (nextReviewDate <= :date OR nextReviewDate IS NULL)")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<com.example.StudyApp.data.Flashcard>> getDueFlashcardsForDeck(long deckId, @org.jetbrains.annotations.NotNull()
    java.util.Date date);
