...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAuthBinding((ConstraintLayout) rootView, btnLogin, btnRegister, etEmail,
          etPassword, progressBar, tilEmail, tilPassword);
    }
