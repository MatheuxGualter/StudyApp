    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(5) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoDecks.equals(_existingDecks)) {
          return new RoomOpenHelper.ValidationResult(false, "decks(com.example.StudyApp.data.Deck).\n"
                  + " Expected:\n" + _infoDecks + "\n"
                  + " Found:\n" + _existingDecks);
        }
        ...
        if (!_infoFlashcards.equals(_existingFlashcards)) {
          return new RoomOpenHelper.ValidationResult(false, "flashcards(com.example.StudyApp.data.Flashcard).\n"
                  + " Expected:\n" + _infoFlashcards + "\n"
                  + " Found:\n" + _existingFlashcards);
        }
        ...
        if (!_infoUserLocation.equals(_existingUserLocation)) {
          return new RoomOpenHelper.ValidationResult(false, "user_location(com.example.StudyApp.data.UserLocation).\n"
                  + " Expected:\n" + _infoUserLocation + "\n"
